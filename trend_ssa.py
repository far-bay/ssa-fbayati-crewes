...
mydata =pd.read_excel('C:\\Users\\Farzaneh\\Documents\\DATA\\oil_production.xlsx')
...
plt.plot(date,data ,'b',date,vector, 'r')
ax.xaxis.set_minor_locator(AutoMinorLocator())
ax.tick_params(which='both', width=2)
ax.tick_params(which='major', length=5)
ax.tick_params(which='minor', length=5)
plt.xlabel('Date')
plt.ylabel('AB conv light ($m^3/day$)')
save_fig("rough_trend")
plt.show()
